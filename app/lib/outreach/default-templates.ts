...
Best,`,
  ...
  },
  {
    ...
    channel: 'linkedin',
    industry: 'Academy',
    body: `Hi {decision_maker_name}, I came across {entity_name} and was impressed by your work. We help academies measure decision-making speed, situational awareness, and working memory under pressure — paired with a live second-screen experience during training. Would love to connect and share how it could apply to your program.`,
...
Best,`,
  ...
  },
  {
    ...
    channel: 'linkedin',
    industry: 'Club',
    body: `Hi {decision_maker_name}, I came across {entity_name} and was impressed by your work. We help clubs measure and improve the cognitive side of performance — decision-making, situational awareness, and working memory — using a live second-screen training experience. Would love to connect.`,
    variables: ['entity_name', 'decision_maker_name', 'value_proposition'],
  },
];
