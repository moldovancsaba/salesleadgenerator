...
Current app version is **2.4.75**. (Corrected 2026-07-25 — this line had drifted to a stale `2.4.29` for a long stretch of releases; `package.json` remains the single source of truth per the line below.)
